...
import textToArray from '../../src/helpers/textToArray';

describe('Convert text to array', () => {
  it('should be the array expected', () => {
  ...
  it('should not be the array expected', () => {
    const filePath = path.resolve(__dirname, '..', 'attach', 'proposals.txt');
    ...
    expect(array).not.toStrictEqual(notExpected);
  });
});